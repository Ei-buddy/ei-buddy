...
| ⬜ A fazer, pode começar hoje |      14 |   38 |
...
> A **NR-061** entra como ✅ **neste PR** (branch
> `feat/NR-061-confirmacao-acao-sensivel`); a `main` só passa a contar o
> squash depois do merge — sem URL de PR ainda.
...
Dos **42 dias que faltam, 38 podem começar hoje** — inclusive NR-015 (deploy na
VM), a cascata E11 no Studio (NR-062 → 115–119 → NR-120) agora que a
NR-121 e a NR-061 estão ✅, depois o canal real (NR-113 + NR-046), e a NR-075 (cupons;
