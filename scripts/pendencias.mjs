...
const PENDENCIAS = [
  ...
  {
    id: 'NR-015 (armazenamento)',
    titulo: 'Onde ficam os arquivos: foto de produto, XML fiscal, anexos',
    chaves: ['STORAGE_ENDPOINT'],
    pronto: () => valor('STORAGE_ENDPOINT') !== undefined,
    destrava: 'a foto do produto voltar ao cadastro, e o XML fiscal sair da VM',
    oQueFazer: [
      'A tabela attachments existe desde a 0007 e guarda storage_path —',
      'um caminho, nao bytes. Nenhum repositorio escreve nela porque nao ha',
      'onde apontar: armazenamento de objeto e a NR-015 (ADR-0015).',
      '',
      'A foto do produto foi RETIRADA da tela ate isso existir: o campo pedia',
      'a imagem, mostrava a previa e descartava no envio — o lojista cadastrava',
      'uma foto que nunca foi guardada.',
      '',
      'Escolhido o provedor (S3, R2, B2, MinIO), volta com o upload atras.',
    ],
  },
  {
    id: 'ADR-0010',
